<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Layout.aspx.vb" Inherits="Default2" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
            ...
            <nav>
                ...
                <asp:SiteMapPath ID="SiteMapPath1" runat="server">
                    ...
                    <div id="container">
                        <h1>Layout Demos</h1>
                        <p>Check out our different layout demos</p>
                            <ul>
